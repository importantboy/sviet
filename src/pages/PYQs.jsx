  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <Herosection
          heading="Previous Year Questions (PYQs)"
          shortDescription="Access comprehensive collection of previous year question papers to enhance your exam preparation. Download PYQs for all subjects and analyze question patterns effectively."
          btnText1="Browse PYQs"
          btn1Href="#pyqs"
          imgSrc="/Home/AddmissionCell.jpeg"
        />

        {/* Search and Filter Section */}
        <section className="py-8 bg-white border-b" id="pyqs">
                ...
                {filteredData.map((program, programIndex) => (
                  <div key={programIndex} className="space-y-6">
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-blue-900 mb-2">{program.program}</h3>
                      ...
                      <Card key={subjectIndex} className="shadow-lg">
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between mb-4">
                            <div>
                              <h4 className="text-xl font-semibold text-blue-900">{subject.name}</h4>
                              <p className="text-gray-600">
                                {subject.code} • {subject.semester}
                              </p>
                            </div>
                            <Badge className="bg-blue-100 text-blue-800">{subject.papers.length} Papers</Badge>
                          </div>
                                ...
                                {subject.papers
                                  ...
                                  .map((paper, paperIndex) => (
                                    <tr key={paperIndex} className="border-b border-gray-200 hover:bg-gray-50">
                                      <td className="py-3 px-4 font-medium text-blue-600">{paper.year}</td>
                                      <td className="py-3 px-4">{paper.session}</td>
                                      <td className="py-3 px-4">
                                        <Badge variant="secondary" className="text-xs">
                                          {paper.type}
                                        </Badge>
                                      </td>
                                      <td className="py-3 px-4 text-center">{paper.marks}</td>
                                      <td className="py-3 px-4 text-center">{paper.duration}</td>
                      ...
                      <Card key={subjectIndex} className="shadow-lg">
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <Badge className="bg-green-100 text-green-800">{subject.papers.length} Papers</Badge>
                          </div>
                            ...
                            <table className="w-full text-sm">
                              ...
                              <tbody>
                                {subject.papers
                                  ...
                                  .map((paper, paperIndex) => (
                                    <tr key={paperIndex} className="border-b border-gray-200 hover:bg-gray-50">
                                      <td className="py-3 px-4 font-medium text-green-600">{paper.year}</td>
                                      <td className="py-3 px-4">{paper.session}</td>
                                      <td className="py-3 px-4">
                                        <Badge variant="secondary" className="text-xs">
                                          {paper.type}
        ...
        <section className="py-16 bg-blue-900 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Exam Preparation Tips</h2>
