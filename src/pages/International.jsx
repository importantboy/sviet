...
const International = () => {
          ...
          if (entry.isIntersecting) {
            ...
            setStatsData((prevStats) => {
              if (!prevStats[index].hasAnimated) {
                ...
                const targetValueStr = newStats[index].value.replace(
                  /[^\d.]/g,
                  ""
                );
  ...
  return (
    <>
      <Helmet>
        <title>International Students - SVIET</title>
      </Helmet>
      <div className="min-h-screen bg-gray-50">
        ...
        <Herosection
          ...
          shortDescription={
            "India's Top Premier Institution. Educating world-wide citizens for a moving world"
          }
        ...
        {/* Stats */}
        <section id="stats" className="py-16 bg-blue-900 text-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 gap-6">
                {youtubeVideos.map((video) => (
                  <Card
                    key={video.id}
                    className="shadow-lg hover:shadow-xl p-0 overflow-hidden transition-shadow duration-300"
                  >
        ...
        <OppertunitiesPage
          bigText={true}
          description="With SVGOI limitless opportunities"
