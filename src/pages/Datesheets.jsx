  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-gray-600 text-base md:text-lg lg:text-xl leading-relaxed">
                Stay updated with current and upcoming examination schedules. Access detailed datesheets, important
                dates, and examination guidelines for all programs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-6 md:py-8 bg-blue-900 text-white" id="datesheets">
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-2">{examSchedule.current.session}</h2>
              <p className="text-blue-200 mb-4 text-sm md:text-base">{examSchedule.current.type}</p>
              <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-8 text-sm md:text-base">
        ...
        <section className="py-8 md:py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-4">Important Dates</h3>
              <p className="text-gray-600 text-sm md:text-base">
                Key dates and deadlines for the current examination session
              </p>
            </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900 text-sm md:text-base">{date.title}</h4>
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-4">Examination Schedule</h3>
              <p className="text-gray-600 text-sm md:text-base">Detailed datesheet for current examination session</p>
            </div>
                  ...
                  <Card key={programIndex} className="shadow-lg">
                    <CardContent className="p-4 md:p-6">
                      <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6 gap-4">
                        <h4 className="text-lg md:text-xl font-bold text-blue-900">{program.program}</h4>
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b bg-blue-50">
                              <th className="text-left py-3 px-2 md:px-4 font-medium text-gray-700">Date</th>
                              <th className="text-left py-3 px-2 md:px-4 font-medium text-gray-700">Subject</th>
                              <th className="text-left py-3 px-2 md:px-4 font-medium text-gray-700">Code</th>
                              <th className="text-left py-3 px-2 md:px-4 font-medium text-gray-700">Time</th>
                              <th className="text-left py-3 px-2 md:px-4 font-medium text-gray-700">Semester</th>
                            </tr>
                          </thead>
                          <tbody>
                            {program.exams.map((exam, examIndex) => (
                              <tr key={examIndex} className="border-b border-gray-200 hover:bg-gray-50">
                                <td className="py-3 px-2 md:px-4 font-medium text-blue-600">
                                ...
                                <td className="py-3 px-2 md:px-4">{exam.subject}</td>
                                <td className="py-3 px-2 md:px-4 font-mono text-gray-600 text-xs md:text-sm">
                                  {exam.code}
                                </td>
                                <td className="py-3 px-2 md:px-4 text-xs md:text-sm">{exam.time}</td>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            {program.exams.map((exam, examIndex) => (
                              <tr key={examIndex} className="border-b border-gray-200 hover:bg-gray-50">
                                <td className="py-3 px-2 md:px-4 font-medium text-green-600">
                                  {new Date(exam.date).toLocaleDateString("en-US", {
                                    weekday: "short",
                                    month: "short",
                                    day: "numeric",
        ...
        <section className="py-12 md:py-16 bg-blue-900 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Examination Guidelines</h2>
                  ...
                  <div className="space-y-4">
                    {examGuidelines.map((guideline, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        ...
                        <p className="text-blue-100 leading-relaxed text-sm md:text-base">{guideline}</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-4">Previous Examination Sessions</h3>
              <p className="text-gray-600 text-sm md:text-base">Access datesheets from previous examination sessions</p>
            </div>
              ...
              {examSchedule.previous.map((session, index) => (
                <Card key={index} className="shadow-md">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1 text-sm md:text-base">{session.session}</h4>
